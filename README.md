...
I created the inverse matrix IPs which run on PYNQ board.
...
The projects that creates each IP areunder the vivado/2017.2/module/ directory.

## License

Copyright 2017 kino2718

Vivadoが自動生成したtclファイルなどを除いた私が作成したファイルは
License は [MIT License](https://choosealicense.com/licenses/mit/) とします。

The files I created, excluding the tcl files automatically generated by Vivado

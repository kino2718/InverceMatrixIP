...
# Create project
create_project LimitNumData ./LimitNumData -part xc7z020clg400-1
...
set obj [get_projects LimitNumData]
set_property -name "default_lib" -value "xil_defaultlib" -objects $obj
set_property -name "ip_cache_permissions" -value "read write" -objects $obj
set_property -name "ip_output_repo" -value "$proj_dir/LimitNumData.cache/ip" -objects $obj
...
set files [list \
 "[file normalize "src/vhdl/LimitNumData.vhd"]"\
]
add_files -norecurse -fileset $obj $files

# Set 'sources_1' fileset file properties for remote files
set file "src/vhdl/LimitNumData.vhd"
...
set obj [get_filesets sources_1]
set_property -name "top" -value "LimitNumData" -objects $obj
...
set file "[file normalize "src/constrs/LimitNumData_ooc.xdc"]"
set file_added [add_files -norecurse -fileset $obj $file]
set file "src/constrs/LimitNumData_ooc.xdc"
set file [file normalize $file]
...
set files [list \
 ...
 "[file normalize "sim/tb/tb_LimitNumData.vhd"]"\
...
set file "sim/tb/tb_LimitNumData.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj
...
set obj [get_filesets sim_1]
set_property -name "top" -value "tb_LimitNumData" -objects $obj
...
puts "INFO: Project created:LimitNumData"

# create IP
set ip_repo ../../ip_repo
set ip_dir $ip_repo/LimitNumData
...
set_property name LimitNumData  [ipx::current_core]
set_property version 1.0 [ipx::current_core]
set_property display_name "LimitNumData for InverceMatrix" [ipx::current_core]
set_property description "LimitNumData IP used in BackSubtraction IP" [ipx::current_core]
...
#set_property previous_version_for_upgrade kino2718.net:user:LimitNumData:1.0 [ipx::current_core]

...
################################################################
# This is a generated script based on design: InternalCell
#
...
# source InternalCell_script.tcl
...
CONFIG.phase_has_tlast {true} \
  ...
  connect_bd_intf_net -intf_net S01_AXIS_1 [get_bd_intf_ports s_axis] [get_bd_intf_pins axis_combiner_0/S01_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_0_M00_AXIS [get_bd_intf_ports m_axis] [get_bd_intf_pins axis_broadcaster_0/M00_AXIS]
  ...
  connect_bd_net -net aclk_1 [get_bd_ports aclk] [get_bd_pins Feedback_0/aclk] [get_bd_pins LastCellValue_0/aclk] [get_bd_pins axis_broadcaster_0/aclk] [get_bd_pins axis_combiner_0/aclk] [get_bd_pins axis_register_slice_0/aclk] [get_bd_pins cordic_0/aclk]
  connect_bd_net -net aresetn_1 [get_bd_ports aresetn] [get_bd_pins Feedback_0/aresetn] [get_bd_pins LastCellValue_0/aresetn] [get_bd_pins axis_broadcaster_0/aresetn] [get_bd_pins axis_combiner_0/aresetn] [get_bd_pins axis_register_slice_0/aresetn]

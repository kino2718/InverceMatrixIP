...
# Create project
create_project AXI4StreamRegister ./AXI4StreamRegister -part xc7z020clg400-1
...
set obj [get_projects AXI4StreamRegister]
set_property -name "default_lib" -value "xil_defaultlib" -objects $obj
set_property -name "ip_cache_permissions" -value "read write" -objects $obj
set_property -name "ip_output_repo" -value "$proj_dir/AXI4StreamRegister.cache/ip" -objects $obj
...
set files [list \
 "[file normalize "src/vhdl/AXI4StreamRegister.vhd"]"\
]
add_files -norecurse -fileset $obj $files

# Set 'sources_1' fileset file properties for remote files
set file "src/vhdl/AXI4StreamRegister.vhd"
...
set obj [get_filesets sources_1]
set_property -name "top" -value "AXI4StreamRegister" -objects $obj
...
set file "[file normalize "src/constrs/AXI4StreamRegister_ooc.xdc"]"
set file_added [add_files -norecurse -fileset $obj $file]
set file "src/constrs/AXI4StreamRegister_ooc.xdc"
set file [file normalize $file]
...
set files [list \
 ...
 "[file normalize "sim/tb/tb_AXI4StreamRegister.vhd"]"\
...
set file "sim/tb/tb_AXI4StreamRegister.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj
...
set obj [get_filesets sim_1]
set_property -name "top" -value "tb_AXI4StreamRegister" -objects $obj
...
puts "INFO: Project created:AXI4StreamRegister"

# create IP
set ip_repo ../../ip_repo
set ip_dir $ip_repo/AXI4StreamRegister
...
set_property name AXI4StreamRegister  [ipx::current_core]
set_property version 1.0 [ipx::current_core]
set_property display_name "AXI4StreamRegister for InverceMatrix" [ipx::current_core]
set_property description "AXI4StreamRegister IP used in BoundaryCell and InternalCell IP" [ipx::current_core]
...
#set_property previous_version_for_upgrade kino2718.net:user:AXI4StreamRegister:1.0 [ipx::current_core]

...
# Create project
create_project Reorder3 ./Reorder3 -part xc7z020clg400-1
...
set obj [get_projects Reorder3]
set_property -name "default_lib" -value "xil_defaultlib" -objects $obj
set_property -name "ip_cache_permissions" -value "read write" -objects $obj
set_property -name "ip_output_repo" -value "$proj_dir/Reorder3.cache/ip" -objects $obj
...
set files [list \
 "[file normalize "src/vhdl/Reorder3.vhd"]"\
]
add_files -norecurse -fileset $obj $files

# Set 'sources_1' fileset file properties for remote files
set file "src/vhdl/Reorder3.vhd"
...
set obj [get_filesets sources_1]
set_property -name "top" -value "Reorder3" -objects $obj
...
set file "[file normalize "src/constrs/Reorder3_ooc.xdc"]"
set file_added [add_files -norecurse -fileset $obj $file]
set file "src/constrs/Reorder3_ooc.xdc"
set file [file normalize $file]
...
set files [list \
 ...
 "[file normalize "sim/tb/tb_Reorder3.vhd"]"\
 "[file normalize "sim/test/col1.txt"]"\
 "[file normalize "sim/test/col2.txt"]"\
 "[file normalize "sim/test/col3.txt"]"\
]
add_files -norecurse -fileset $obj $files
...
set file "sim/tb/tb_Reorder3.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj
...
set obj [get_filesets sim_1]
set_property -name "top" -value "tb_Reorder3" -objects $obj
...
puts "INFO: Project created:Reorder3"

# create IP
set ip_repo ../../ip_repo
set ip_dir $ip_repo/Reorder3
...
set_property name Reorder3  [ipx::current_core]
set_property version 1.0 [ipx::current_core]
set_property display_name "Reorder3 for InverceMatrix" [ipx::current_core]
set_property description "Reorder3 IP used in BoundaryCell and InternalCell IP" [ipx::current_core]
...
#set_property previous_version_for_upgrade kino2718.net:user:Reorder3:1.0 [ipx::current_core]

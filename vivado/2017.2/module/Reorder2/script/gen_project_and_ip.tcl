...
# Create project
create_project Reorder2 ./Reorder2 -part xc7z020clg400-1
...
set obj [get_projects Reorder2]
set_property -name "default_lib" -value "xil_defaultlib" -objects $obj
set_property -name "ip_cache_permissions" -value "read write" -objects $obj
set_property -name "ip_output_repo" -value "$proj_dir/Reorder2.cache/ip" -objects $obj
...
set files [list \
 "[file normalize "src/vhdl/Reorder2.vhd"]"\
]
add_files -norecurse -fileset $obj $files

# Set 'sources_1' fileset file properties for remote files
set file "src/vhdl/Reorder2.vhd"
...
set obj [get_filesets sources_1]
set_property -name "top" -value "Reorder2" -objects $obj
...
set file "[file normalize "src/constrs/Reorder2_ooc.xdc"]"
set file_added [add_files -norecurse -fileset $obj $file]
set file "src/constrs/Reorder2_ooc.xdc"
set file [file normalize $file]
...
set files [list \
 ...
 "[file normalize "sim/tb/tb_Reorder2.vhd"]"\
...
set file "sim/tb/tb_Reorder2.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj
...
set obj [get_filesets sim_1]
set_property -name "top" -value "tb_Reorder2" -objects $obj
...
puts "INFO: Project created:Reorder2"

# create IP
set ip_repo ../../ip_repo
set ip_dir $ip_repo/Reorder2
...
set_property name Reorder2  [ipx::current_core]
set_property version 1.0 [ipx::current_core]
set_property display_name "Reorder2 for InverceMatrix" [ipx::current_core]
set_property description "Reorder2 IP used in InverceMatrix2 IP" [ipx::current_core]
...
#set_property previous_version_for_upgrade kino2718.net:user:Reorder2:1.0 [ipx::current_core]

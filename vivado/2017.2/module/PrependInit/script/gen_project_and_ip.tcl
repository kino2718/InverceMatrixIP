...
# Create project
create_project PrependInit ./PrependInit -part xc7z020clg400-1
...
set obj [get_projects PrependInit]
set_property -name "default_lib" -value "xil_defaultlib" -objects $obj
set_property -name "ip_cache_permissions" -value "read write" -objects $obj
set_property -name "ip_output_repo" -value "$proj_dir/PrependInit.cache/ip" -objects $obj
...
set files [list \
 "[file normalize "src/vhdl/PrependInit.vhd"]"\
]
add_files -norecurse -fileset $obj $files

# Set 'sources_1' fileset file properties for remote files
set file "src/vhdl/PrependInit.vhd"
...
set obj [get_filesets sources_1]
set_property -name "top" -value "PrependInit" -objects $obj
...
set file "[file normalize "src/constrs/PrependInit_ooc.xdc"]"
set file_added [add_files -norecurse -fileset $obj $file]
set file "src/constrs/PrependInit_ooc.xdc"
set file [file normalize $file]
...
set files [list \
 ...
 "[file normalize "sim/tb/tb_PrependInit.vhd"]"\
 "[file normalize "sim/test/input.txt"]"\
 "[file normalize "sim/test/init.txt"]"\
]
add_files -norecurse -fileset $obj $files
...
set file "sim/tb/tb_PrependInit.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj
...
set obj [get_filesets sim_1]
set_property -name "top" -value "tb_PrependInit" -objects $obj
...
puts "INFO: Project created:PrependInit"

# create IP
set ip_repo ../../ip_repo
set ip_dir $ip_repo/PrependInit
...
set_property name PrependInit  [ipx::current_core]
set_property version 1.0 [ipx::current_core]
set_property display_name "PrependInit for InverceMatrix" [ipx::current_core]
set_property description "PrependInit IP used in DivCell and MultSubCell IP" [ipx::current_core]
...
#set_property previous_version_for_upgrade kino2718.net:user:PrependInit:1.0 [ipx::current_core]

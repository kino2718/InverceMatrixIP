...
# Create project
create_project StreamToColumns3 ./StreamToColumns3 -part xc7z020clg400-1
...
set obj [get_projects StreamToColumns3]
set_property -name "default_lib" -value "xil_defaultlib" -objects $obj
set_property -name "ip_cache_permissions" -value "read write" -objects $obj
set_property -name "ip_output_repo" -value "$proj_dir/StreamToColumns3.cache/ip" -objects $obj
...
set files [list \
 "[file normalize "src/vhdl/StreamToColumns3.vhd"]"\
]
add_files -norecurse -fileset $obj $files

# Set 'sources_1' fileset file properties for remote files
set file "src/vhdl/StreamToColumns3.vhd"
...
set obj [get_filesets sources_1]
set_property -name "top" -value "StreamToColumns3" -objects $obj
...
set file "[file normalize "src/constrs/StreamToColumns3_ooc.xdc"]"
set file_added [add_files -norecurse -fileset $obj $file]
set file "src/constrs/StreamToColumns3_ooc.xdc"
set file [file normalize $file]
...
set files [list \
 ...
 "[file normalize "sim/tb/tb_StreamToColumns3.vhd"]"\
...
set file "sim/tb/tb_StreamToColumns3.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj
...
set obj [get_filesets sim_1]
set_property -name "top" -value "tb_StreamToColumns3" -objects $obj
...
puts "INFO: Project created:StreamToColumns3"

# create IP
set ip_repo ../../ip_repo
set ip_dir $ip_repo/StreamToColumns3
...
set_property name StreamToColumns3  [ipx::current_core]
set_property version 1.0 [ipx::current_core]
set_property display_name "StreamToColumns3 for InverceMatrix" [ipx::current_core]
set_property description "StreamToColumns3 IP used in QRDecomp2 IP" [ipx::current_core]
...
#set_property previous_version_for_upgrade kino2718.net:user:StreamToColumns3:1.0 [ipx::current_core]

...
# Create project
create_project Divider2FixedPoint ./Divider2FixedPoint -part xc7z020clg400-1
...
set obj [get_projects Divider2FixedPoint]
set_property -name "default_lib" -value "xil_defaultlib" -objects $obj
set_property -name "ip_cache_permissions" -value "read write" -objects $obj
set_property -name "ip_output_repo" -value "$proj_dir/Divider2FixedPoint.cache/ip" -objects $obj
...
set files [list \
 "[file normalize "src/vhdl/Divider2FixedPoint.vhd"]"\
]
add_files -norecurse -fileset $obj $files

# Set 'sources_1' fileset file properties for remote files
set file "src/vhdl/Divider2FixedPoint.vhd"
...
set obj [get_filesets sources_1]
set_property -name "top" -value "Divider2FixedPoint" -objects $obj
...
set file "[file normalize "src/constrs/Divider2FixedPoint_ooc.xdc"]"
set file_added [add_files -norecurse -fileset $obj $file]
set file "src/constrs/Divider2FixedPoint_ooc.xdc"
set file [file normalize $file]
...
set files [list \
 ...
 "[file normalize "sim/tb/tb_Divider2FixedPoint.vhd"]"\
...
set file "sim/tb/tb_Divider2FixedPoint.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj
...
set obj [get_filesets sim_1]
set_property -name "top" -value "tb_Divider2FixedPoint" -objects $obj
...
puts "INFO: Project created:Divider2FixedPoint"

# create IP
set ip_repo ../../ip_repo
set ip_dir $ip_repo/Divider2FixedPoint
...
set_property name Divider2FixedPoint  [ipx::current_core]
set_property version 1.0 [ipx::current_core]
set_property display_name "Divider2FixedPoint for InverceMatrix" [ipx::current_core]
set_property description "Divider2FixedPoint IP used in DivCell IP" [ipx::current_core]
...
#set_property previous_version_for_upgrade kino2718.net:user:Divider2FixedPoint:1.0 [ipx::current_core]

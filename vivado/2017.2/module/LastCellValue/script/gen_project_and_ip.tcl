...
# Create project
create_project LastCellValue ./LastCellValue -part xc7z020clg400-1
...
set obj [get_projects LastCellValue]
set_property -name "default_lib" -value "xil_defaultlib" -objects $obj
set_property -name "ip_cache_permissions" -value "read write" -objects $obj
set_property -name "ip_output_repo" -value "$proj_dir/LastCellValue.cache/ip" -objects $obj
...
set files [list \
 "[file normalize "src/vhdl/LastCellValue.vhd"]"\
]
add_files -norecurse -fileset $obj $files

# Set 'sources_1' fileset file properties for remote files
set file "src/vhdl/LastCellValue.vhd"
...
set obj [get_filesets sources_1]
set_property -name "top" -value "LastCellValue" -objects $obj
...
set file "[file normalize "src/constrs/LastCellValue_ooc.xdc"]"
set file_added [add_files -norecurse -fileset $obj $file]
set file "src/constrs/LastCellValue_ooc.xdc"
set file [file normalize $file]
...
set files [list \
 ...
 "[file normalize "sim/tb/tb_LastCellValue.vhd"]"\
...
set file "sim/tb/tb_LastCellValue.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj
...
set obj [get_filesets sim_1]
set_property -name "top" -value "tb_LastCellValue" -objects $obj
...
puts "INFO: Project created:LastCellValue"

# create IP
set ip_repo ../../ip_repo
set ip_dir $ip_repo/LastCellValue
...
set_property name LastCellValue  [ipx::current_core]
set_property version 1.0 [ipx::current_core]
set_property display_name "LastCellValue for InverceMatrix" [ipx::current_core]
set_property description "LastCellValue IP used in BoundaryCell and InternalCell IP" [ipx::current_core]
...
#set_property previous_version_for_upgrade kino2718.net:user:LastCellValue:1.0 [ipx::current_core]

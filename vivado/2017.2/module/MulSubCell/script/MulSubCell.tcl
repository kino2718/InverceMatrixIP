...
################################################################
# This is a generated script based on design: MulSubCell
#
...
proc create_root_design { parentCell } {
  ...
  set s_axis_from_right [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:axis_rtl:1.0 s_axis_from_right ]
...
CONFIG.TUSER_WIDTH {0} \
  ...
  set_property -dict [ list \
CONFIG.CLK_DOMAIN {MulSubCell_aclk} \
CONFIG.FREQ_HZ {100000000} \
  ...
  connect_bd_intf_net -intf_net PrependInit_0_m_axis [get_bd_intf_pins PrependInit_0/m_axis] [get_bd_intf_pins MultiplySubtractor_0/s_axis_c]
  ...
  connect_bd_intf_net -intf_net s_axis_from_right_1 [get_bd_intf_ports s_axis_from_right] [get_bd_intf_pins PrependInit_0/s_axis]
  ...
  connect_bd_intf_net -intf_net s_axis_y_1 [get_bd_intf_ports s_axis_y] [get_bd_intf_pins PrependInit_0/s_axis_init]

  # Create port connections
  connect_bd_net -net aclk_1 [get_bd_ports aclk] [get_bd_pins PrependInit_0/aclk] [get_bd_pins MultiplySubtractor_0/aclk]
  connect_bd_net -net aresetn_1 [get_bd_ports aresetn] [get_bd_pins PrependInit_0/aresetn] [get_bd_pins MultiplySubtractor_0/aresetn]
